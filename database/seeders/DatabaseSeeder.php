...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $packages = [
            [
                'code' => 'LM-50M',
                'name' => 'Life Fiber 50 Mbps - Hemat',
                'speed' => '50 Mbps',
                'price' => 250000,
                'description' => 'Ideal untuk penggunaan browsing harian, meeting Zoom, dan 3-5 perangkat aktif.',
                'features' => ['Kecepatan hingga 50 Mbps', '100% Fiber Optic murni', 'Gratis Sewa ONT Wi-Fi Router', 'Unlimited Tanpa FUP'],
                'is_popular' => false,
                'is_active' => true,
            ],
            [
                'code' => 'LM-100M',
                'name' => 'Life Fiber 100 Mbps - Paling Laris',
                'speed' => '100 Mbps',
                'price' => 350000,
                'description' => 'Paket favorit keluarga untuk streaming 4K tanpa buffering dan kerja dari rumah multi-perangkat.',
            ...
            [
                'code' => 'LM-200M',
                'name' => 'Life Gamer 200 Mbps - Pro Gamer',
                'speed' => '200 Mbps',
                'price' => 550000,
                'description' => 'Koneksi ultra-stabil dengan routing low-latency khusus gaming dan content creator.',
                'features' => ['Kecepatan simetris 200 Mbps', 'Gaming Traffic Routing Priority', 'Dual Band Wi-Fi 6 Router', 'Free 1 Mesh WiFi Extender'],
                'is_popular' => false,
                'is_active' => true,
            ],
            [
                'code' => 'LM-300M',
                'name' => 'Life Ultra 300 Mbps - Ultimate',
                'speed' => '300 Mbps',
                'price' => 850000,
                'description' => 'Kecepatan maksimal untuk smart home, kantor, dan kebutuhan bandwidth masif tanpa batas.',
                'features' => ['Kecepatan simetris 300 Mbps', 'Free 4K Android Smart Box (100+ Channels)', 'Dedicated Bandwidth Support', 'Free 2 Unit Mesh Wi-Fi 6'],
                'is_popular' => false,
                'is_active' => true,
            ],
        ];

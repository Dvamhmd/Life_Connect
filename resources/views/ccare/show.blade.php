    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-5 space-y-6">
            ...
            @if(Auth::user()->role === 'admin_vas')
                ...
                <div class="rounded-3xl bg-white border-2 border-[#9B385B]/30 p-6 shadow-sm space-y-4 text-xs">
                    ...
                    <form action="{{ route('vas.registrations.update-status', $registration->id) }}" method="POST" class="space-y-3.5">
                        ...
                        <div>
                            ...
                            <select name="status" id="adminVasStatusSelectCCare" required onchange="toggleAdminVasCCareRevisionBox(this.value)"
                        ...
                        <div id="adminVasCCareRevisionCategoryBox" class="{{ $registration->status === 'revision' ? '' : 'hidden' }} space-y-1">
                ...
                <script>
                    function toggleAdminVasCCareRevisionBox(status) {
                        const box = document.getElementById('adminVasCCareRevisionCategoryBox');
                        if (box) {
                            if (status === 'revision') {
